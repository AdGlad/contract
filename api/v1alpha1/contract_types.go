...
type ContractSpec struct {
	...
	// PageType is the confluence type of page
	PageType string `json:"pagetype,omitempty"`
	// PageTitle is the confluence page title
	PageTitle string `json:"pagetitle,omitempty"`
	// PageSpace is the confluence page space
	PageSpace string `json:"pagespace,omitempty"`
	// PageBody is the confluence page body content
	PageBody string `json:"pagebody,omitempty"`
}
